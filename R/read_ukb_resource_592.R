...
#'
#' @description Reads selected sheets from the UK Biobank Resource 592 Excel
#'   file (`all_lkps_maps_v4.xlsx`, [resource
...
#'   metadata.
#'
#'   The function automatically includes required dependencies for sheets that
#'   need extension processing. For example, requesting `"read_v2_drugs_bnf"`
#'   will automatically include `"bnf_lkp"` and `"read_v2_drugs_lkp"` for
#'   extending the mapping with BNF hierarchy information.
#'
#' @param path Path to the UKB Resource 592 Excel file. Default uses
#'   [get_ukb_resource_592()] to download the file if needed.
#' @param sheets Character vector of sheet names to read. Available sheets are:
#'   * Lookup tables: `"bnf_lkp"`, `"dmd_lkp"`, `"icd9_lkp"`, `"icd10_lkp"`,
#'   `"read_v2_lkp"`, `"read_v2_drugs_lkp"`, `"read_ctv3_lkp"`
#'   * Mapping tables: `"icd9_icd10"`, `"read_v2_drugs_bnf"`, `"read_v2_icd9"`,
...
#'
#'   Sheets may contain one or more of these components depending on the data.
#'
#' @details ## Auto-dependency inclusion
#'
...
#'
#' Missing dependencies are automatically added with an informative message.
#'
