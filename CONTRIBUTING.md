...
First of all, thanks for considering contributing to codemapper! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on codemapper. 😊

codemapper is an open source project, maintained by people who care. We
are not directly funded to do so.

## Code of conduct

Please note that this project is released with a [Contributor Code of
Conduct](https://codeminer-io.github.io/codeminer/CODE_OF_CONDUCT.md).
...
Think codemapper is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using codemapper for a paper you are writing? Consider [citing
it](https://rmgpanw.github.io/codemapper/authors.html).

### Ask a question ⁉️

Using codemapper and got stuck? Browse the
[documentation](https://rmgpanw.github.io/codemapper) to see if you can
find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/rmgpanw/codemapper/issues/new). While we
...
Have an idea for a new codemapper feature? Take a look at the
[documentation](https://rmgpanw.github.io/codemapper) and [issue
list](https://github.com/rmgpanw/codemapper/issues) to see if it isn’t
...
Using codemapper and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/rmgpanw/codemapper/issues/new) so we can fix
...
[This website](https://rmgpanw.github.io/codemapper) is generated with
...
issue](https://github.com/rmgpanw/codemapper/issues/new) and we can
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/rmgpanw/codemapper).
...
Care to fix bugs or implement new functionality for codemapper? Awesome!
👏 Have a look at the [issue
list](https://github.com/rmgpanw/codemapper/issues) and leave a comment
...
1.  Fork [this repo](https://github.com/rmgpanw/codemapper) and clone it
