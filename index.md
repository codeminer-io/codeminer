...
See
[`vignette('codeminer')`](https://codeminer-io.github.io/codeminer/articles/codeminer.md)
for further details, including how to build a clinical codelist with R
Shiny using `RunCodelistBuilder()`.
