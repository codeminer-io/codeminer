...
#> Writing lookup and mapping tables to Duckdb database at /tmp/RtmpCHrX3n/file1c3620ce7c2.db
...
#> icd10_phecode
#> metadata_codeminer
#> Success! Connect to database with `con <- DBI::dbConnect(duckdb::duckdb(), '/tmp/RtmpCHrX3n/file1c3620ce7c2.db', read_only = TRUE)`, then access all tables with `all_lkps_maps <- ukbwranglr::db_tables_to_list(con)`
```
